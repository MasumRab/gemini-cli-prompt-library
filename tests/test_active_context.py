...
import requests
from scripts.update_active_context import get_repository, fetch_paginated, main
...
class TestActiveContextUpdater(unittest.TestCase):
    ...
    def test_main_missing_token(self, mock_file, mock_get_repo, mock_fetch, mock_env_get):
        mock_env_get.return_value = None
        main()
    ...
    def test_main_success_with_prs(self, mock_file, mock_fetch, mock_get_repo, mock_env_get):
        ...
        self.assertIn("| [#101](https://github.com/owner/repo/pull/101) | Fix bug | @dev1 | `src/main.py`<br>`README.md` |", written_content)
